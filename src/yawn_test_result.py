...
# TEST_DATA_DIR = r"C:\Users\Talha\OneDrive\Desktop\ML_Project\train_yawn"  # or separate test folder

basedir = os.path.abspath(os.path.dirname(__file__))
project_root = os.path.dirname(basedir)
MODEL_PATH = os.path.join(project_root, 'models/yawn_cnn.h5')
TEST_DATA_DIR = os.path.join(project_root, 'train_yawn')


MODEL_NAME = "Yawn Detection Model"
TRAINING_IMAGE_SIZE = (96, 96) 
BATCH_SIZE = 32
